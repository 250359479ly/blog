            ...
            <li class="nav-item">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="javascript:void(0);" onclick="fullScreen('添加文章','${APP_PATH}/admin/article/add')">文章</a>
...
<div class="card mb-3">
    <div style="height: 180px;overflow: hidden">
        <img class="card-img-top" src="${APP_PATH}/static/img/82839-106.jpg" alt="Card image cap" style="height: 100%;width:100%;">
    </div>
