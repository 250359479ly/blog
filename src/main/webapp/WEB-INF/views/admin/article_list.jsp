...
<head>
    <meta charset="UTF-8">
    <title>博客管理系统</title>
    <link rel="stylesheet" href="${APP_PATH}/static/css/bootstrap4.0.min.css" >
    <script src="${APP_PATH}/static/js/jquery.slim.min.js" ></script>
    <script src="${APP_PATH}/static/js/popper.min.js" ></script>
    <script src="${APP_PATH}/static/js/bootstrap4.0.min.js"></script>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light" >
    ...
    <a class="navbar-brand text-success" href="${APP_PATH}/admin/main">博客管理</a>
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item ">
                <a class="nav-link" href="${APP_PATH}/admin/main">主页 </a>
            </li>
            <li class="nav-item active">
                <a class="nav-link" href="${APP_PATH}/admin/article/list">文章管理</a>

            </li>

        </ul>
        <form class="form-inline my-2 my-lg-0" action="${APP_PATH}/admin/article/search" method="GET">
        ...
        <a class="btn btn-outline-danger btn-sm" href="${APP_PATH}/admin/logout" role="button">退出</a>
    </div>
</nav>
<br/>
...
<nav aria-label="Page navigation example" style="position: absolute;bottom: 10px;left: 42%">
    <ul class="pagination justify-content-center">
        <li class="page-item  <c:if test="${pageInfo.pageNum==1}">disabled</c:if> ">
            <a class="page-link" href="${APP_PATH}/admin/article/list?page=1" >&laquo;</a>
        </li>
        <c:forEach begin="1" end="${pageInfo.pages}" step="1" var="pageNo">
            <li class="page-item <c:if test="${pageInfo.pageNum==pageNo}">active</c:if>"><a class="page-link" href="${APP_PATH}/admin/article/list?page=${pageNo}">${pageNo}</a></li>
        </c:forEach>
        <li class="page-item  <c:if test="${pageInfo.pageNum==pageInfo.pages}">disabled</c:if> ">
            <a class="page-link" href="${APP_PATH}/admin/article/list?page=${pageInfo.pages}">&raquo;</a>
        </li>
    </ul>
</nav>
